...
function _pdfGen($user, $pass)
{
   ...
   $items2 = array(
      "You should follow Exeter IT top tips (see www.exeter.ac.uk/it/cybersecurity/), which will help to protect you, your information and the University."
   );
   $text12 = "\n\nPlease turn over the page.";
   $text13 = "Data Protection Act\n\n";
   $text14 = "The University of Exeter is registered with the Information Commissioner's Office as required under the Data Protection Act 1998. Academic Services will be holding information for purposes including administration of computer resources, maintenance of records, keeping our users informed, and responding to any query that may be raised with us. Personal data will only be disclosed to members of the University, its agents or the data subject's organisation in accordance with the University's registration and current data protection legislation.\nPlease refer to www.exeter.ac.uk/recordsmanagement for more information about Data Protection.\n\n";
   $text15 = "\nRegulations\n\n";
   $text16 = "You should read the Regulations relating to the use of Information Technology facilities and abide by them. The Regulations are available online at www.exeter.ac.uk/ig/policy/\n\n";
   $text17 = "\nServices Available\n\n";
   $text18 = "Many computing facilities and services are available to all members of the University; more information can be found on the web at www.exeter.ac.uk/it.\n\nDetails of training are available at www.exeter.ac.uk/staff/development/technical/it/.\n\n";
   $text19 = "\nUniversity email account\n\n";
   $text20 = "University business should only be conducted using your University email account. Please consult the web pages available from www.exeter.ac.uk/it/howdoi/email/ for information about using email at the University.\n\n";
#   $text21 = "\nLeaving\n\n";
