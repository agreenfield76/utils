...
function top_menu()
{
        ...
        print "<p>If you are a $insiders_formal user, you may:" .
              ...
              "of files prior to using this facility would improve the security of your data. An unsupported " .
              "utility for compressing and encrypting files is <a href=\"http://www.exeter.ac.uk/infosec/encryptfiles/\">7-Zip</a></p>\n" .
              "<p>Please also consider compressing files prior to transfer to conserve available upload space.</p>\n" .
