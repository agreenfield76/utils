...
//              "and data integrity, the ability to upload to the University's File Drop Box site ceased on June 30th 2019. " .
//              "All uploads must be moved to the University's OneDrive allocation, " .
//              "details of which can be found <a href=\"https://as.exeter.ac.uk/it/files/onedrive/\">here</a>. " .
//              "As previously notified the entire Drop Box site will be disabled in 7 days. </font></p>\n" .
...
//              "<p><b>Non-person email accounts</b> (i.e. shared generic email addresses) may not be validated for this service.</p>\n";
        print "<p>This service is no longer available</p>\n" . 
              "<p>All uploads must be moved to the University's OneDrive allocation, " .
              "details of which can be found <a href=\"https://as.exeter.ac.uk/it/files/onedrive/\">here</a>.</p>\n";
}
